...
class Produk {
    ...
    public function __construct($judul= "judul", $penulis = "penulis", $penerbit="penerbit", $harga=0, $jmlhalaman=0, $waktumain=0) { // mengapa menggunakan garis bawah, karena contructor merupakan bagian dari magic method atau method special yg dimiliki oleh PHp
...
$produk3 = new komik("Naruto", "Mashasi Kisimoto", "Shounen jump", 30000, 100, 0); 
...
$produk4 = new game("Alcehmia Story", "Asobimo", "Play Store", 10000, 0, 50);
